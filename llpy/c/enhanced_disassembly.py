...
if _version <= (3, 2):
    ...
    GetToken = _library.function(ctypes.c_int, 'EDGetToken', [ctypes.POINTER(EDTokenRef), Inst, ctypes.c_int])
    ...
    LiteralTokenAbsoluteValue = _library.function(ctypes.c_int, 'EDLiteralTokenAbsoluteValue', [ctypes.POINTER(uint64), Token])
    RegisterTokenValue = _library.function(ctypes.c_int, 'EDRegisterTokenValue', [ctypes.POINTER(unsigned), Token])
